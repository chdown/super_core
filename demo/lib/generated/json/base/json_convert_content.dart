...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<ShopTablesEntity>[] is M) {
      return data.map<ShopTablesEntity>((Map<String, dynamic> e) => ShopTablesEntity.fromJson(e)).toList() as M;
    }
    if (<ShopTablesInfos>[] is M) {
      return data.map<ShopTablesInfos>((Map<String, dynamic> e) => ShopTablesInfos.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (ShopTablesEntity).toString(): ShopTablesEntity.fromJson,
    (ShopTablesInfos).toString(): ShopTablesInfos.fromJson,
  };
